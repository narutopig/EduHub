        ...
        <div className="pt-24">
          <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
              ...
              <SignInWithGoogle
                handleClick={async () => router.push("/auth/main")}
              ></SignInWithGoogle>
              <h1 className="my-4 text-5xl font-bold leading-tight">
                It's Time to Travel
              </h1>
              <p className="leading-normal text-2xl mb-8">
                Find out the best parks for travel
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-wrap">
              <div className="w-5/6 sm:w-1/2 p-6">
                ...
                <p className="text-gray-600 mb-8">
                  You have the ability to share you personal experiences as well
                  as learn about others experiences.
                  <br />
                  <br />
                </p>
              </div>
            ...
            <div className="flex flex-wrap flex-col-reverse sm:flex-row">
              ...
              <div className="w-full sm:w-1/2 p-6 mt-6">
                <div className="align-middle">
                  ...
                  <p className="text-gray-600 mb-8">
                    Plan your trips with our software that allows you to choose
                    what park you want to find based on their activites. The
                    parks will be shown via google maps to you.
                    <br />
                    <br />
                  </p>
                </div>
              ...
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                >
                  ...
                  <p className="text-gray-800 text-base px-6 mb-5">
                    I take my family to parks once a week and this app helps us
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                >
                  ...
                  <p className="text-gray-800 text-base px-6 mb-5">
                    This app has helped with my Eagle Scouts programs
                    tremendously with planning a variety of activities every
                    weekend. They all enjoy travelling to these places!
                  </p>
                </a>
              </div>
              <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                >
                  ...
                  <p className="text-gray-800 text-base px-6 mb-5">
                    This app helps me in choosing where I want to hike anytime
                    and anywhere, whether it's 5 in the morning or across the
                    country!
                  </p>
                </a>
              </div>
